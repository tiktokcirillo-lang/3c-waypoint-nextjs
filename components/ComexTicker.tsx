...
const TERMS = [
  'HTSUS', 'CBP', 'ISF', 'AD/CVD', 'UFLPA', 'FTZ', 'DRAWBACK', 'NVOCC',
  'C-TPAT', 'HTS', '19 CFR', 'ENTRY BOND', 'CUSTOMS BROKER',
  'FREIGHT FORWARDER', 'IMPORTER SECURITY FILING', 'ANTIDUMPING',
  'COUNTERVAILING DUTY', 'BONDED WAREHOUSE',
];
