    ...
    <div className="relative z-10 w-full h-full flex items-center">
      <div className="px-8 md:px-16 lg:px-20 xl:px-24 w-full max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col gap-[0.06em] mb-10 md:mb-14">
          <MaskedLine index={0} className="font-['Barlow_Condensed'] text-[clamp(3.2rem,9.5vw,10rem)] font-black uppercase tracking-[-0.025em] text-white">
            {t('headline.line1')}
          </MaskedLine>
          <MaskedLine index={1} className="font-['Barlow_Condensed'] text-[clamp(3.2rem,9.5vw,10rem)] font-black uppercase tracking-[-0.025em] text-[#7ECECA]">
            {t('headline.line2')}
          </MaskedLine>
          <MaskedLine index={2} className="font-['Barlow_Condensed'] text-[clamp(3.2rem,9.5vw,10rem)] font-black uppercase tracking-[-0.025em] text-white">
            {t('headline.line3')}
          </MaskedLine>
          <MaskedLine index={3} className="font-['Barlow_Condensed'] text-[clamp(3.2rem,9.5vw,10rem)] font-black uppercase tracking-[-0.025em] text-white/30">
            {t('headline.line4')}
          </MaskedLine>
        </div>
